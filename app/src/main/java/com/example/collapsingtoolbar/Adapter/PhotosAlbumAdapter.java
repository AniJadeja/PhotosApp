...
public class PhotosAlbumAdapter extends RecyclerView.Adapter<PhotosAlbumAdapter.MyViewHolder> {
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            listner.onclick(getAdapterPosition(),IMAGE);            //Returning the current clicked position and type as image to the implemented method.
        }
    }

    public  interface  OnAlbumClickListner{         //Interface to generate call back when user clicked an image.
